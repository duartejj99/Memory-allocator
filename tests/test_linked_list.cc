/******************************************************
 * Copyright Juan José García Duarte  2021 - 2025     *
...
TEST(Linked_list, remove_element_at_the_middle)
{
...
TEST(Linked_list, remove_element_pointed_by_head)
{
  ...
  // Act
  void *removed_block = remove_element(&head, head);

  // Assert
  ASSERT_EQ(old_head, removed_block);
  ASSERT_EQ(head, second_element);
  ASSERT_EQ(*(void **)head, third_element);
}

TEST(Linked_list, remove_element_at_the_end)
{
  ...
  // Act
  void *removed_block = remove_element(&head, fourth_element);

  // Assert
  ASSERT_EQ(*(void **)third_element, (void *)NULL);
  ASSERT_EQ(removed_block, fourth_element);
}